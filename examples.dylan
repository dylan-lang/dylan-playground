...
// Some collected examples to use in the playground.  This file is a bit unusual because
// of the long multi-line strings, each of which holds a full example. The entire file is
// one big vector.  Adding a new example should ONLY require adding a new mapping to this
// table since the Examples menu will be generated from this.
